      ...
      <DialogContent className="max-w-sm">
        ...
        <div className="grid grid-cols-2 gap-3 py-4">
          <button
            ...
            className="flex flex-col items-center gap-3 p-4 rounded-lg border border-slate-700 hover:border-cyan-500/50 hover:bg-slate-800/50 transition-all"
          >
          ...
          <button
            ...
            className="flex flex-col items-center gap-3 p-4 rounded-lg border border-slate-700 hover:border-green-500/50 hover:bg-slate-800/50 transition-all"
          >
